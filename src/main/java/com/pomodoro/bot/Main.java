...
public class Main {
    ...
    static class PomodoroBot extends TelegramLongPollingBot {
        ...
        public String getBotToken() {
            return "5699114328:AAFJtngObqvjxXVrdRwXkv-H-pM9-S0IYK0";
        }
        ...
        public void onUpdateReceived(Update update) {
            if (update.hasMessage() && update.getMessage().hasText()) {
                ...
                if (update.getMessage().getText().equals("/start")) {
                            ...
                            Задай мне время работы и отдыха через пробел. 
                            Например, '1 1'.
                    ...
                    if (args.length > 1) {
                        ...
                        // save
                        // system.now() - 18:47
                        // хранилище ->все истекшие таймеры
    ...
    static class  EchoBot extends TelegramLongPollingBot {
        ...
        public void onUpdateReceived(Update update) {
            ...
            if (update.hasMessage() && update.getMessage().hasText()) {
                ...
                if (update.getMessage().getText().equals("/start")) {
                    userCount++;
                    sendMsg(chatId, "Привет, я попугай бот. Буду повторять всё за тобой");
                } else {
